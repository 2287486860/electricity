...
if __name__ == '__main__':
    ...
    # Images
    imgs = [
        'ultralytics/assets/zidane.jpg',  # filename
        Path('ultralytics/assets/zidane.jpg'),  # Path
        'https://ultralytics.com/images/zidane.jpg',  # URI
        cv2.imread('ultralytics/assets/bus.jpg')[:, :, ::-1],  # OpenCV
        Image.open('ultralytics/assets/bus.jpg'),  # PIL
